...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">{{ 'Active Fiscal Year' }}</div>
                    <div class="card-body">
                        <livewire:active-fisacal-year-set/>
                    </div>
                </div>
            ...
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form
                            action="{{ $fiscalYear->id ? route('fiscal-years.update', $fiscalYear) : route('fiscal-years.store') }}"
                            method="post">
                            @csrf
                            @if ($fiscalYear->id)
                                @method('put')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="fiscal_year"
                                    ...
                                    value="{{ old('fiscal_year', $fiscalYear->fiscal_year) }}" id="name"
