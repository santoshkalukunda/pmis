...
class BudgetController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(StoreBudgetRequest $request, Project $project)
    {
        $project->budget()->create($request->validated());
        return redirect()
            ->back()
    ...
    {
        $office = $budget->project->office;
        $project = $budget->project;

        $budget->update($request->validated());
         return redirect()
            ->route('projects.budgets', [$office, $project])
